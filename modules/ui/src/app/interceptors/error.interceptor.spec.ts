...
describe('ErrorInterceptor', () => {
  let notificationServiceMock: jasmine.SpyObj<NotificationService> = jasmine.createSpyObj(['notify']);
  ...
  it('should notify about other errors', (done) => {
    ...
    interceptor.intercept(requestMock, next).subscribe(() => {
      ...
      () => {
        ...
        expect(notificationServiceMock.notify).toHaveBeenCalledWith('BE is not responding. Please, try again later.');
        done();
      },);
  });
