...
<<<<<<< HEAD:modules/ui/src/app/progress/progress-status-card/progress-status-card.component.spec.ts
...
>>>>>>> dev:modules/ui/src/app/pages/testrun/components/progress-status-card/progress-status-card.component.spec.ts
import {
