...
| security.tls.v1_3_client | Device uses TLS with connection to an external service on port 443 (or any other port which could be running the webserver-HTTPS) | | The packet indicates a TLS 1.3 connection using AEAD-based ciphers | | Informational |
